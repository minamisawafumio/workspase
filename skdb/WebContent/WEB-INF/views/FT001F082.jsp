...
<body>
FT001F082
<spring:url value="/FT001F082/form" var="url" htmlEscape="true" />
<form:form action="${url}" method="post" modelAttribute="FT001F082Form">
    ...
    <div>
		<form:input id="FT001F082_btn01" type="submit" path="back" name="back" value="戻る" />
	</div>
    <div>
		<form:input id="FT001F082_btn02" type="submit" path="doExecute"  name="doExecute" value="決定" />
	</div>
